...
const intro = () => {
  const introList = [
    ...
    '6+ years responsive web development (CSS3, HTML5, browser & device support)',
  ...
  return (
    <div className="Intro">
      <h3 className="Intro__heading font--bold">I'm a front-end web developer with over ten years experience building websites, widgets and JavaScript web apps.</h3>
